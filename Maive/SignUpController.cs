...
namespace Maive
{
	partial class SignUpController : UIViewController
	{
		...
		public override void ViewDidLoad()
		{
			...
			CALayer AccountButton = btnCreateAccount.Layer;
			AccountButton.CornerRadius = 45; // relative to the width/height of imageview (50%)
			AccountButton.MasksToBounds = true;
			...
			this.txtConfirm.ShouldReturn += (textField) => 
			{
				textField.ResignFirstResponder();
				return true;
			};
